...
class Face(Base):
    ...
    faceId = Column(String, primary_key=True, index=True)
    face_embedding = Column(LargeBinary)
    original_photo = Column(String)
    norm_photo = Column(String)
    ...
    def update(self, **kwarg):
        ...
        self.norm_photo = kwarg.get("norm_photo", None) if kwarg.get("norm_photo", None) != self.norm_photo else self.norm_photo
